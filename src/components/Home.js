		...
		this.state = {
			...
			projectsList: [
				...
				},
				{
					...
					description: 'A custom WordPress site for Portico Healthnet, a healcare advocacy nonprofit in Minnesota.',
					industries: [
						'healthcare',
						'consumer-services',
						'nonprofit',
									...
									<div className="projects">
										{null !== industryOptionSelected
											? (getIndustryName(industryOptionSelected)
												? <p className="results">
													Showing {projects.length} {resultText} in the industry &ldquo;{getIndustryName(industryOptionSelected)}&rdquo;
													<button
														className="clear"
														onClick={
