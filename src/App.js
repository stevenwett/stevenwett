    ...
    <div className="app">
      <BrowserRouter>
        <Switch>
          ...
          <Route exact path='/ux-projects/gemini-memorial-designer' component={ProjectGeminiMemorialDesigner} />
          <Route exact path='/ux-projects/gemini-partner-portal' component={ProjectGeminiPartnerPortal} />
          <Route exact path='/ux-projects/gemini-truequote' component={ProjectGeminiTrueQuote} />
          {/*<Route exact path='/ux-projects/northfield-wifi' component={ProjectNorthfieldWiFi} />*/}
          <Route exact path='/ux-projects/mica-projects' component={ProjectMICAProjects} />
