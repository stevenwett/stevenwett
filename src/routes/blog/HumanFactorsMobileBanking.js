...
class HumanFactorsMobileBanking extends React.Component {
	...
	render() {
		// const {} = this.state;
		const title = 'The Human Factors of Mobile Banking | Blog | Steven Wett';
		const description = 'A usability inspection of the human factors of a few mobile banking apps.';
		const url = 'https://stevenwett.com/blog/human-factors-mobile-banking';
