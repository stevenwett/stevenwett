					...
					<Container>
						<Row>
							<Col xs={12} md={10} lg={8} xl={6} className="intro-content">
								...
								<p>Within the portal there are also two self-serve quoting tools, <Link to="/ux-projects/gemini-truequote">TrueQuote</Link> and <Link to="/ux-projects/gemini-memorial-designer">Memorial Designer</Link>, which my co-worker and I developed at an earlier time.</p>
							</Col>
						</Row>
					</Container>
				</div>
