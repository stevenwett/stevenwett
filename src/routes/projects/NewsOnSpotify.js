...
class NewsOnSpotify extends React.Component {
	...
	render() {
		...
		// 	settings,
		// } = this.state;
		const title = 'News On Spotify | Work | Steven Wett';
		const description = 'A class project where I designed and tested a news feature for Spotify.';
		const url = 'https://stevenwett.com/work/news-on-spotify';
