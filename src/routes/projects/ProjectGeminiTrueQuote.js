					...
					<Container>
						<Row>
							<Col xs={12} md={10} lg={8} xl={6}>
								...
								<p className="date">Project launched in 2018</p>
								<p>TrueQuote is a web app that is within the <Link to="/projects/gemini-partner-portal">Gemini Partner Portal</Link> and is used by signage industry customers to quote and order products from the manufacturer. This project was launched in 2018 and I have been doing periodic upgrades, including porting it to a new server environment in 2022.</p>
