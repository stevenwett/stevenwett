...
class NewsOnSpotify extends React.Component {
	...
	render() {
		...
		// 	settings,
		// } = this.state;
		const title = 'Field Guide Hiking App: Hike·n·Seek | Work | Steven Wett';
		const description = 'A class project where I teamed up with three other UX designers to design an exploration and hiking app.';
		const url = 'https://stevenwett.com/work/hike-n-seek';
		const image = '/images/og-project-hike-n-seek.png';
